...
#ifndef CODECPLUSPLUS_OPENGRID_H
#define CODECPLUSPLUS_OPENGRID_H
...
public:
    ...
    OpenGrid(int gap, int maxX, int maxY) : mGap(gap), mNumberX(maxX * gap), mNumberY(maxY * gap){
    }
...
#endif //CODECPLUSPLUS_OPENGRID_H
